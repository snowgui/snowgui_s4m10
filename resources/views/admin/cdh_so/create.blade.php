...
<form action="{{ Route('CDHSo.store') }}" class="form-validar form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                {{csrf_field()}}                
                @include('admin.cdh_so._form')
            </div>
            <div class="panel-footer text-center">
                <a class="btn btn-danger btn-voltar" href="{{route('CDHSo.index')}}">Voltar</a>
