    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="form-group">
                ...
                <select name="role_id" class="form-control" data-dependent="state">
                        <option selected disabled>Selecione...</option>
                    @foreach($roles as $r)
                        <option value="{{$r->id}}" {{isset($r->role) && $r->id == @$data->role_id ? 'selected' : ''}}>{{$r->role}}</option>
                    @endforeach
                </select>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="btn-group">
                            ...
                            {{-- <button class="btn btn-warning" id="setDrag" type="button">Novo Corte</button> --}}
                        </div>
                    </div>
                </div>
            </div>
